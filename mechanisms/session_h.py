...
Usage:
  python mechanisms/session_h.py --model Qwen/Qwen2.5-1.5B-Instruct
  python mechanisms/session_h.py --model Qwen/Qwen2.5-1.5B-Instruct --phase verify
  python mechanisms/session_h.py --model Qwen/Qwen2.5-1.5B-Instruct --scenarios 3
"""
...
DATA_DIR = MECH_DIR / "session_h_data"
